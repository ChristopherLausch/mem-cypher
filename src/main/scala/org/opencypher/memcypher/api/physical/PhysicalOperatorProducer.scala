...
import org.opencypher.memcypher.impl.physical.{InnerJoin, JoinType}
...
/**
  ...
  * called by [[org.opencypher.memcypher.impl.physical.PhysicalPlanner]], a default implementation for physical planning.
  *
...
trait PhysicalOperatorProducer[P <: PhysicalOperator[R, G, C], R <: CypherRecords, G <: PropertyGraph, C <: RuntimeContext[R, G]] {
  ...
  def planRemoveAliases(in: P, aliases: AliasExpr, header: RecordHeader): P
  ...
  /**
    ...
    */
  def planOrderBy(in: P, sortItems: Seq[SortItem], header: RecordHeader): P
